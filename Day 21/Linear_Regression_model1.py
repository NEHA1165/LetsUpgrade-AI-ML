...
plt.title('Linear Regression price v/s sqft_living(training set)')
plt.xlabel('sqft_living')
plt.ylabel('price')
plt.show()
...
plt.title('Linear Regression price v/s sqft_living(testing set)')
plt.xlabel('sqft_living')
plt.ylabel('price')
plt.show()
...
unseen_predict=lin_reg.predict(np.array([[1060]]))
