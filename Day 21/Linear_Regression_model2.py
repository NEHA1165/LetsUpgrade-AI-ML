...
plt.title('Linear Regression price v/s bedrooms(training set)')
plt.xlabel('bedrooms')
plt.ylabel('price')
plt.show()
...
plt.title('Linear Regression price v/s bedrooms(testing set)')
plt.xlabel('bedrooms')
plt.ylabel('price')
plt.show()
...
unseen_predict=lin_reg.predict(np.array([[10]]))
